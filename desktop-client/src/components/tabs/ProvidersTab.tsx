...
export default function ProvidersTab() {
  ...
  useEffect(() => {
    if (selectedProvider) {
      ...
      const current = new Set(
        configuredModels.filter((m) => m.startsWith(prefix)),
      );
  ...
  const handleSaveSelection = async () => {
    ...
    try {
      ...
      toast(
        "success",
        `Saved ${selectedModels.size} models for ${selectedProvider}`,
      );
  ...
  if (selected && selectedProvider) {
    ...
    return (
      <div style={{ animation: "fadeIn 0.15s ease-out" }}>
        ...
        <span
          className="text-[11px] font-mono block mb-4"
        ...
        {models.length > 0 ? (
          <div>
            <span
              ...
              style={{ color: "var(--text-muted)" }}
            >
              Available Models ({models.length}) — {selectedModels.size}{" "}
              selected
            </span>
            <div
              ...
              {models.map((model) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {checked && (
                        <Check size={10} style={{ color: "#09090b" }} />
                      )}
                    </div>
                    <span
          ...
          <div>
            ...
            <span
              ...
              style={{ color: "var(--text-muted)" }}
            >
              Click "Fetch Models" to see all available models and modify
              selection.
            </span>
          </div>
        ) : (
          <span
            ...
            style={{ color: "var(--text-muted)" }}
          >
            No models configured. Click "Fetch Models" to discover available
            models.
          </span>
        )}
      </div>
    ...
    <div style={{ animation: "fadeIn 0.15s ease-out" }}>
      ...
      <div className="flex flex-col gap-1">
        {providers.map((provider) => {
          ...
          const modelCount = configuredModels.filter((m) =>
            m.startsWith(prefix),
          ).length;
          return (
            <div
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.background = provider.active
                  ? "rgba(255,255,255,0.03)"
                  : "transparent";
              }}
            >
