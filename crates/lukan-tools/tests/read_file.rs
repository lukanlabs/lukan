...
async fn read_file_honors_offset_and_limit() {
    ...
    assert!(result.content.contains("... (3 more lines, 5 total)") || result.content.contains("... (2 more lines, 5 total)"));
}
...
async fn read_file_returns_image_payload_for_png() {
    ...
    let png_bytes: &[u8] = &[
        ...
        0xDA, 0x63, 0xFC, 0xFF, 0x1F, 0x00, 0x03, 0x03, 0x02, 0x00, 0xEF, 0xBF, 0x55, 0x2D,
