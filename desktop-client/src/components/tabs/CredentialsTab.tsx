...
const PROVIDERS: ProviderEntry[] = [
  ...
  {
    provider: "lukan-cloud",
    field: "lukanCloudApiKey",
    label: "Lukan Cloud",
    envVar: "LUKAN_CLOUD_API_KEY",
  },
  {
    provider: "gemini",
    field: "geminiApiKey",
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <input
                ...
                onChange={(e) =>
                  setCreds({
                    ...creds,
                    [selected.field]: e.target.value || undefined,
                  })
                }
              />
              <button
            ...
            {testResult && (
              <div
                style={{
                  ...
                  color:
                    testResult.status === "success" ? "#4ade80" : "#fb7185",
            ...
            <div style={{ display: "flex", gap: 6 }}>
              <button
                ...
                style={{
                  opacity: testing || !selectedStatus?.configured ? 0.4 : 1,
                }}
              >
                {testing ? (
